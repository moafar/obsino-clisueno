...
def procesar_dam_doc(texto_relevante: str):
    logging.info("Procesando examen DAM DOC")
    datos = {}
    ...
    campos = [
        ...
        ("latencia_total", r"latencia de sueno fue[^\d]*(\d+[,.]\d+)"),
...
def procesar_dam_rtf(texto_relevante: str):
    logging.info("Procesando examen DAM RTF")
    datos = {}
